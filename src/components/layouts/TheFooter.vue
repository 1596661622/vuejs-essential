    ...
    <div class="container">
      <div class="row footer-top">
        <div class="col-sm-5 col-lg-5">
          ...
          <div class="text-md">
            <a v-for="item in contacts" v-titles="item.title" :href="item.link" :style="contactStyle" target="_blank">
              ...
              <ul class="list-unstyled">
                <li v-for="item in sponsor.list">
                  <a :href="item.link" target="_blank">
                    <img v-titles="item.title" :src="item.logo" :alt="item.title" class="footer-sponsor-link" width="98">
                  </a>
                </li>
              </ul>
            </div>
            ...
            <div class="col-sm-4">
              ...
              <ul class="list-unstyled">
                <li v-for="item in other.list">
                  <a :href="item.link" v-titles="item.title" target="_blank">
...
<script>
import titles from '@/directives/title'
